...
const DEMO_DATA = {
  expenses: [
    // Work Lunches
    { date: '2025-12-16', day: 'MON', merchant: 'Pret A Manger', amount: 8.45, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2025-12-17', day: 'TUE', merchant: 'Leon', amount: 9.20, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2025-12-18', day: 'WED', merchant: 'Wasabi', amount: 7.95, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2025-12-19', day: 'THU', merchant: 'EAT.', amount: 8.75, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2025-12-20', day: 'FRI', merchant: 'Itsu', amount: 10.50, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2026-01-06', day: 'MON', merchant: 'Pret A Manger', amount: 8.95, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2026-01-07', day: 'TUE', merchant: 'Greggs', amount: 6.40, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2026-01-08', day: 'WED', merchant: 'Leon', amount: 9.85, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2026-01-09', day: 'THU', merchant: 'Wasabi', amount: 8.30, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2026-01-10', day: 'FRI', merchant: 'Itsu', amount: 11.20, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2026-01-13', day: 'MON', merchant: 'EAT.', amount: 9.15, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2026-01-14', day: 'TUE', merchant: 'Pret A Manger', amount: 8.60, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2026-01-15', day: 'WED', merchant: 'Leon', amount: 10.05, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2026-01-16', day: 'THU', merchant: 'Wasabi', amount: 7.80, location: 'Kings Cross', expenseType: 'Lunch' },
    { date: '2026-01-17', day: 'FRI', merchant: 'Itsu', amount: 10.95, location: 'Kings Cross', expenseType: 'Lunch' },
    // Qatar Trip
    { date: '2026-02-01', day: 'SAT', merchant: 'Qatar Airways', amount: 45.00, location: 'Doha', expenseType: 'Flight Meal' },
    { date: '2026-02-01', day: 'SAT', merchant: 'Hamad Airport Duty Free', amount: 22.50, location: 'Doha', expenseType: 'Travel' },
    { date: '2026-02-02', day: 'SUN', merchant: 'Souq Waqif Restaurant', amount: 38.75, location: 'Doha', expenseType: 'Dinner' },
    { date: '2026-02-02', day: 'SUN', merchant: 'Café Arabian', amount: 12.30, location: 'Doha', expenseType: 'Lunch' },
    { date: '2026-02-03', day: 'MON', merchant: 'Business Center Café', amount: 8.50, location: 'Doha', expenseType: 'Coffee' },
    { date: '2026-02-03', day: 'MON', merchant: 'Al Mourjan Restaurant', amount: 52.00, location: 'Doha', expenseType: 'Dinner' },
    { date: '2026-02-04', day: 'TUE', merchant: 'Hotel Breakfast', amount: 18.00, location: 'Doha', expenseType: 'Breakfast' },
    { date: '2026-02-04', day: 'TUE', merchant: 'Local Transport', amount: 15.40, location: 'Doha', expenseType: 'Transport' },
    { date: '2026-02-04', day: 'TUE', merchant: 'Persian Restaurant', amount: 41.20, location: 'Doha', expenseType: 'Dinner' },
    { date: '2026-02-05', day: 'WED', merchant: 'Conference Lunch', amount: 28.90, location: 'Doha', expenseType: 'Lunch' },
    { date: '2026-02-05', day: 'WED', merchant: 'Taxi to Venue', amount: 22.00, location: 'Doha', expenseType: 'Transport' },
    { date: '2026-02-06', day: 'THU', merchant: 'Shopping Centre Food Court', amount: 16.75, location: 'Doha', expenseType: 'Lunch' },
    { date: '2026-02-06', day: 'THU', merchant: 'Uber to Airport', amount: 35.60, location: 'Doha', expenseType: 'Transport' },
    { date: '2026-02-07', day: 'FRI', merchant: 'Airport Lounge', amount: 42.00, location: 'Doha', expenseType: 'Travel' },
  ],
  total: 0,
  count: 0,
